...
<head>
    <title>Founders &#8211; Dairy Farm</title>
    <meta charset="UTF-8" />
        ...
        <div class="top_panel_title top_panel_style_1 title_present breadcrumbs_present scheme_original">
            <div  class="bg_cust_1 top_panel_title_inner top_panel_inner_style_1 title_present_inner breadcrumbs_present_inner">
                ...
                <div class="breadcrumbs">
                        ...
                        <span class="breadcrumbs_item current">Manikhant Chakrasali</span> -->
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="content">
                    <article class="post_item post_item_single_team post_featured_right post_format_standard team type-team has-post-thumbnail hentry">
                        <section class="post_featured single_team_post_featured">
                            <div class="post_thumb" data-image="image/mani.jpg" data-title="Manikhanth Chakrasali">
                                <a class="hover_icon hover_icon_view" href="image/mani.jpg" title="Manikhanth Chakrasali">
                                <img alt="" src="image/mani.jpg">
                        ...
                        <section class="single_team_post_description">
                            <h2 class="team_title">Manikhant Chakrasali</h2>
                            <h6 class="team_position">Exicuter</h6>
                            <div class="team_meta">
                                <p>E-mail: <a href="https://manikhantchakrasali2105@gmail.com" class="__cf_email__" data-cfemail="9cf5f2faf3dce5f3e9eeeff5e8f9b2fff3f1" taget="_blank">manikhantchakrasali2105@gmail.com</a></p>
                                <p>Student ID: 20U12023 </p>
                            </div>
        ...
        <div class="page_content_wrap page_paddings_yes">
            <div class="content_wrap">
                <div class="content">
                    <article class="post_item post_item_single_team post_featured_right post_format_standard team type-team has-post-thumbnail hentry">
                        <section class="post_featured single_team_post_featured">
                            <div class="post_thumb" data-image="image/smg.jpg" data-title="Sachin Gasti">
                                <a class="hover_icon hover_icon_view" href="image/smg.jpg" title="Sachin Gasti">
                                    <img alt="" src="image/smg.jpg">
                                </a>
                            </div>
                            <div class="socials_single_team">
                                <div class="sc_socials sc_socials_type_icons sc_socials_shape_round sc_socials_size_tiny">
                        ...
                        <section class="single_team_post_description">
                            <h2 class="team_title">Sachin Gasti</h2>
                            <h6 class="team_position">Co-Exicuter</Co-Exicuter></h6>
                            <div class="team_meta">
                                <p>E-mail: <a href="htpps://www.gamil.sachingasti146@gmail.com" class="__cf_email__" data-cfemail="9cf5f2faf3dce5f3e9eeeff5e8f9b2fff3f1">sachingasti146@gmail.com</a></p>
                                <p>Student ID: 20U12035 </p>
                            </div>
                            <div class="team_brief_info">
                                <h5 class="team_brief_info_title">Brief info</h5>
                                <div class="team_brief_info_text">
                                    ...
                                    monitoring of financial transactions. This system is designed to connect customers and 
                                    distributors for the purpose of buying and selling milk products. The system provides a userfriendly interface for customers to browse and purchase milk and milk products, as well as a 
                                    streamlined process for distributors to manage their inventory and orders
                                    </p>
                                </div>
                            </div>
                        </section>
