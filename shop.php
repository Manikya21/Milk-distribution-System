                        ...
                        <div class="columns_wrap columns_fluid">
							...
							<?php
								if (isset($_SESSION['uid'])) {
                                    $uid = $_SESSION['uid'];
                                    $query = "SELECT * FROM tblproduct WHERE id = '$uid'";
                                    $result = mysqli_query($con, $query);
                                    while ($row = mysqli_fetch_array($result)) {
                                      // code to display product information
                                    }
                                  } else {
                                    // code to handle the case where $_SESSION['uid'] is not set
                                  }
                                ...
                                <div class="post_item_wrap">
                                    <div class="post_featured">
                                        <div class="post_thumb">
                                            ...
                                            <?php
                                            $attachment = wp_get_attachment_url($product->get_image_id());
                                            if(!is_null($attachment)) {
                                            echo '<img src="' . $attachment . '" class="attachment-shop_catalog size-shop_catalog" alt="" />';
                                            }
                                            ?>
