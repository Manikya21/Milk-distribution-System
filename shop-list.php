...
?>
<!DOCTYPE html>
<html lang="en-IN" class="scheme_original">
<head>
                    ...
                    <div class="content_wrap">
                        <div class="columns_wrap columns_fluid">
                            <div class="column-4_5 contact_logo">
                                <div class="logo">
                                    <a href="index.php">
                                        <img src="images/logo3.png" class="logo_main" alt="" width="239" height="59">
                                    </a>
                                </div>
                            </div>
							<?php               
                    ...
                    <div class="content_wrap clearfix">
                        <nav class="menu_main_nav_area menu_hover_fade">
                             <ul id="menu_main" class="menu_main_nav">
                                 <li class="menu-item current-menu-ancestor"><a href="index.php"><span>Home</span></a>
                                            </li>
                                            ...
                                            <li class="menu-item current-menu-parent menu-item-has-children"><a href="shop-list.php"><span>Products</span></a></li>
                    ...
                    <div class="list_products shop_mode_list">
                        ...
                        <ul class="products">
                            ...
                            while ($result=mysqli_fetch_assoc($query)) {
                                ?>
                                <li class="product has-post-thumbnail column-1_3 first instock purchasable">
                                    <div class="post_item_wrap">
                                        <div class="post_featured">
                                            <div class="post_thumb">
                                                <a class="hover_icon hover_icon_link" href="single-product.php">
                                                    <img src="admin/<?php echo $result['imagepath'];?>"
                                        ...
                                        <div class="post_content">
                                            <h2 class="woocommerce-loop-product__title">
                                                <a href="single-product.php"><?php echo $result['name']; $id=$result['id'];?></a>
                                            </h2>
                                            ...
                                            <span class="price">
                                        <?php
                                        //  $sql2="select * from tblproduct where productcategoryid=$id order by price";
                                      $sql2="select * from tblproduct where productcategoryid=$id and expire_date between CURRENT_DATE and expire_date and quntity>0 order by price";
                                        //echo $sql2;
                                        ...
                                        ?>
                                            ...
                                            <a rel="nofollow" href="single-product.php?id=<?php echo $result['id'];?>" data-quantity="1"
                                ...
                                <div class="price_slider_wrapper">
                                    ...
                                    <div class="price_slider_amount">
                                        ...
                                        <div class="price_label">Price:
                                            ...
                                            <span class="to">{{price | currency:""}}</span>
                                        </div>
                                        <input type="hidden" name="q" value="shop.php" />
                                        <div class="clear"></div>
                                    </div>
