                                                            ...
                                                            <div id="sc_form_104_wrap" class="sc_form_wrap">
                                                                <div id="sc_form_104" class="sc_form sc_form_style_form_custom">
                                                                    ...
                                                                    <div class="sc_form_item sc_form_item_text sc_form_field label_top margin_bottom_medium">
                                                                        ...
                                                                        <input id="p" type="text" name="txtpassword" placeholder="Enter your Password." value="<?php
                                                                        if (isset($password)) {
                                                                            echo $password;
                                                                        }
                                                                        ?>">
                                                            ...
                                                            <div id="sc_form_104_wrap" class="sc_form_wrap">
                                                                <div id="sc_form_104" class="sc_form sc_form_style_form_custom">
                                                                    ...
                                                                    <div class="sc_form_item sc_form_item_text sc_form_field label_top margin_bottom_medium">
                                                                        ...
                                                                        <input type="text" name="txtcpassword" placeholder="Enter your Password Again" value="<?php
                                                                        if (isset($password)) {
                                                                            echo $password;
                                                                        }
                                                                        ?>">
