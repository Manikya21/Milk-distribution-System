...
<footer class="call_wrap"  data-animation="animated fadeInUp normal">
    <div class="call_wrap_inner">
        <div class="content_wrap">
            <h2 class="call-title">Where to Buy</h2>
            <div class="call-text">Our Products are currently available at selected Distributors..</div>
            <!--<a class="sc_button sc_button_size_large sc_button_style_border" href="#">Store Locator</a>-->
        </div>
    </div>
</footer>
<footer class="footer_wrap widget_area scheme_original"  data-animation="animated fadeInUp normal">
        ...
        <div class="content_wrap">
            <div class="columns_wrap">
                ...
                <aside class="column-1_4 widget widget_text">
                    <div class="textwidget">Savanur, Haveri 581118
                        <br>
                        <span class="accent1">Phone: +91 9108296502</span>
                        <br> Whatsapp: +91 6362510146
                        <br> Email: <a href="#" class="__cf_email__">dairyproduct@gmail.com</a></div>
                </aside>
                <aside class="column-1_4 widget widget_text">
    ...
    <div class="copyright_wrap_inner">
        <div class="content_wrap">
            ...
            <div class="copyright_text">
                <!--p>
                    DMS.com © 2019 All Rights Reserved
