    ...
    <body class="index home page body_style_wide body_filled article_style_stretch layout_single-standard template_single-standard scheme_original top_panel_show top_panel_above sidebar_hide sidebar_outer_hide vc_responsive">
        ...
        <div class="body_wrap">
            <div class="page_wrap">
                    ...
                    <div class="top_panel_wrap_inner top_panel_inner_style_4 top_panel_position_above">
                        <div class="top_panel_middle">
                            <div class="content_wrap">
                                <div class="contact_logo" data-animation="animated fadeInLeft normal">
                                    <div class="logo">
                                        <a href="index.php">
                                            <img src="images/logo3.png" class="logo_main" alt="" width="250" height="69">
                                            <img src="images/logo3.png" class="logo_fixed" alt="" width="250" height="69">
                                        </a>
                                    </div>
                                </div>
								<!--<?php
                                ...
                                <div class="menu_main_wrap" data-animation="animated fadeInDown normal">
                                    <nav class="menu_main_nav_area menu_hover_fade">
                                        <ul id="menu_main" class="menu_main_nav">
                                            ...
                                            <li class="menu-item "><?php echo $welcome ?>
                ...
                <div class="header_mobile" data-animation="animated fadeInLeft normal"> 
                    <div class="content_wrap">
                    ...
                    <div class="side_wrap" data-animation="animated fadeInDown normal">
                        ...
                        <div class="panel_top">
                            <nav class="menu_main_nav_area">
                                <ul id="menu_mobile" class="menu_main_nav">
                                    ...
                                    <li class="menu-item"><a href="about-2.php"><span>About us</span></a></li>
                                    ...
                                    <li class="menu-item"><a href="contacts.php"><span>Contacts</span></a></li>
                                    <li class="menu-item"><a href="cart.php"><span>Cart</span></a></li>
                                    <li class="menu-item "><?php echo $welcome ?></li>
                                        <!-- <ul>
                        ...
                        <div id="rev_slider_1_1" class="rev_slider fullwidthabanner" data-version="5.2.6">
                            <ul>
                                <li data-index="rs-1" data-transition="cube" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/home-1-slide-1-100x50.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                    <img src="images/photo/aakalu.jpg" alt="" title="home-1-slide-1" width="1903" height="873" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                                ...
                                <li data-index="rs-2" data-transition="cube-horizontal" data-slotamount="default" data-hideafterloop="0" data-hideslideonmobile="off" data-easein="default" data-easeout="default" data-masterspeed="default" data-thumb="images/home-1-slide-2-100x50.jpg" data-rotate="0" data-saveperformance="off" data-title="Slide" data-param1="" data-param2="" data-param3="" data-param4="" data-param5="" data-param6="" data-param7="" data-param8="" data-param9="" data-param10="" data-description="">
                                    <img src="images/photo/cow3.jpeg" alt="" title="home-1-slide-2" width="1903" height="873" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
                                    ...
                                    <div class="tp-caption ButtonText rev-btn" id="slide-2-layer-3" data-x="center" data-hoffset="" data-y="center" data-voffset="151" data-width="['auto']" data-height="['auto']" data-transform_idle="o:1;" data-transform_hover="o:1;rX:0;rY:0;rZ:0;z:0;s:0;e:Linear.easeNone;" data-style_hover="c:rgba(255, 255, 255, 1.00);bg:rgba(255, 255, 255, 0);bc:rgba(255, 255, 255, 1.00);" data-transform_in="y:bottom;rZ:90deg;sX:2;sY:2;s:800;e:Quad.easeIn;" data-transform_out="opacity:0;s:300;" data-start="3970" data-splitin="none" data-splitout="none" data-actions='[{"event":"click","action":"simplelink","target":"_blank","url":".\/shop-list.php","delay":""}]' data-responsive_offset="on" data-responsive="off">View our products </div>
                                </li>
                        ...
                        <div class="content">
                            <article class="post_item post_item_single post_featured_default post_format_standard page type-page hentry">
                                <section class="post_counters">
                                                ...
                                                <div class="wpb_wrapper">
                                                    <div class="sc_section margin_bottom_small section_style_dark_text" data-animation="animated fadeInUp normal">
                                                        <div class="sc_section_inner">
                                                            <h2 class="sc_section_title sc_item_title sc_item_title_without_descr">Welcome<span></span></h2>
                                                            <div class="sc_section_content_wrap">
                                                                <div class="sc_section sc_section_block margin_bottom_large aligncenter mw800">
                                                                    <div class="sc_section_inner">
                                                                        <div class="sc_section_content_wrap">
                                                                            <span class="sc_highlight fst_1">Here you will find a wide range of healthy and fresh dairy products. Welcome </span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                    ...
                                                    <div id="sc_services_918_wrap" class="sc_services_wrap">
                                                        <div id="sc_services_918" class="sc_services sc_services_style_services-1 sc_services_type_images  margin_top_large margin_bottom_large fwidth" data-animation="animated fadeInUp normal">
                                                            <div class="sc_columns columns_wrap">
                                                                <div class="column-1_3 column_padding_bottom" style="padding-bottom:30px;padding-left:10px">
                                                                    <div id="sc_services_918_1" class="sc_services_item sc_services_item_1 odd first">
                                                                        <div class="sc_services_item_featured post_featured">
                                                                            <div class="post_thumb" data-image="" data-title="Dairy Management System">
                                                                                <a class="hover_icon hover_icon_link" href="about-2.php">
                                                                                    <img alt="" src="images/photo/our.jpeg">
                                                                                </a>
                                                                            </div>
                                                                        </div>
                                                                        <div class="sc_services_item_content">
                                                                            <h4 class="sc_services_item_title">
                                                                                <a href="about-2.php">Our Dairy Management System</a>
                                                                            </h4>
                                                                ...
                                                                <!--<div class="column-1_3 column_padding_bottom">
                                                                    <div id="sc_services_918_3" class="sc_services_item sc_services_item_3 odd">
                                                                        ...
                                                                        <div class="sc_services_item_content">
                                                                            <h4 class="sc_services_item_title">
                                                                                <a href="shop-list.php">Our Organic Food</a>
                                                                            </h4>
                                                                            <div class="sc_services_item_description">
                                                                                <div class="wpb_text_column wpb_content_element ">
                                                                                    <div class="wpb_wrapper">
                                                                                ...
                                                                                <a href="shop-list.php" class="sc_button sc_button_square sc_button_style_filled sc_button_size_small">shop now</a>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div-->
                                    ...
                                    <div class="vc_row wpb_row vc_row-fluid  inverse_colors" style="background-image:url(images/photo/bg.jpg) !important;background-position: center !important;background-repeat: no-repeat !important;background-size: cover !important;">
                                                        ...
                                                        <div class="sc_section_inner">
                                                            <div class="sc_section_content_wrap">
                                                                ...
                                                                <div class="sc_section margin_bottom_huge section_style_call_section">
                                                                    <div class="sc_section_inner">
                                                                        <h2 class="sc_section_title sc_item_title sc_item_title_without_descr">From Our website<br />
                                                                            to Yours</h2>
                                        ...
                                        <div class="wpb_column vc_column_container vc_col-sm-5">
                                            <div class="vc_column-inner vc_custom_1475235352066">
                                                <div class="wpb_wrapper">
                                                    <figure class="sc_image  sc_image_shape_square margin_top_huge" data-animation="animated fadeInRight normal"><img src="images/photo/karu2.jpg" alt="" style="border-radius:50%" /></figure>
                                                </div>
                                            </div>
                                        </div>
                                                                                            ...
                                                                                            <div class="sc_section aligncenter">
                                                                                                <div class="sc_section_inner">
                                                                                                    <div class="sc_section_content_wrap">
                                                                                                        ...
                                                                                                        <div class="wpb_text_column wpb_content_element ">
                                                                                                            <div class="wpb_wrapper">
                                                                                                            <p>We Started distributing our product.Our milk is pure so everyone reference to our milk in haveri.</p>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            ...
                                                                                            <div class="sc_section aligncenter">
                                                                                                <div class="sc_section_inner">
                                                                                                    <div class="sc_section_content_wrap">
                                                                                                        ...
                                                                                                        <div class="wpb_text_column wpb_content_element ">
                                                                                                            <div class="wpb_wrapper">
                                                                                                            <p>In 2023, We lunch our website and giving online delivery in particular area in Haveri district. </p>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            ...
                                                                                            <div class="sc_section aligncenter">
                                                                                                <div class="sc_section_inner">
                                                                                                    <div class="sc_section_content_wrap">
                                                                                                        ...
                                                                                                        <div class="wpb_text_column wpb_content_element ">
                                                                                                            <div class="wpb_wrapper">
                                                                                                                <p>In 2022, We lunch our website and giving door to door delivery in particular area in City. </p>
                                                                                                            </div>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
