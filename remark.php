										...
										<div class="wpb_wrapper">
											<div class="sc_table margin_bottom_medium">
                                                ...
                                                <div class="row" style="margin-top: 5%;">
                                                    <b><label class="sc_form_message"><a target="_blank" style="cursor: pointer; font-size: x-large;" href="purchase_bill.php?billno=<?php echo $_SESSION['billno'];?>">Click here to DOWNLOAD/PRINT your Bill.</a></label></b>
                                                </div>
                                                ...
                                                <br><div class="column-1_1" style="margin-top: 10%"><a class="button icon-basket" href="shop-list.php">&nbsp;Continue Shopping</a></div>
											</div>
										</div>
									</div>
								</div>
