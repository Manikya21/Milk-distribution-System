	...
	if (isset($_POST['btn_submit'])) {
		...
		if (empty($username) || empty($password)) {
			...
			if ($result->num_rows == 1) {
				...
				$strerr = "*You Cannot Access this. Please Contact the Manager";
                    ...
                    <div class="top_panel_wrap_inner top_panel_inner_style_1 top_panel_position_above">
                        <div class="top_panel_top">
                            <div class="content_wrap clearfix">
                                ...
                                <div class="top_panel_top_open_hours icons icon-clock-1">Mn-Fr: 8am - 8pm, St-Sn: 8am - 8pm</div>
...
data-animation="animated fadeInDown normal">
                        ...
                        <div class="top_panel_middle" data-animation="animated fadeInLeft normal">
                            ...
                            <div class="content_wrap clearfix">
                                <nav class="menu_main_nav_area menu_hover_fade">
                                    <ul id="menu_main" class="menu_main_nav">
                                        ...
                                        <li class="menu-item"><a href="admin/login.php"><span>Distributor</span></a></li>
